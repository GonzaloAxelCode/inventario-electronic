...
export class TopnavComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  allNavItems: NavItem[] = [
    ...
    },
    {
      ...
      subItems: [
        { route: '/app/proveedores#listado', label: 'Listado de Proveedores', icon: 'M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z', description: 'Todos los proveedores' },
        { route: '/app/proveedores#registrar', label: 'Registrar Proveedor', icon: 'M12 6v6m0 0v6m0-6h6m-6 0H6', description: 'Agregar nuevo proveedor' },
      ],
    },
    {
    ...
    },
    {
      ...
      subItems: [
        ...
        { route: '/app/settings/seguridad', label: 'Seguridad', icon: 'M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z', description: 'Contraseña y sesiones' },
  ...
  calculateVisibleItems() {
    ...
    this.filteredItems = this.allNavItems.filter(
      item => !item.superuserOnly || this.user?.is_superuser
    );
